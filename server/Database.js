...
class Database {
  ...
  /** @type {typeof import('./models/UserLibraryItem')} */
  get userLibraryItemModel() {
    return this.models.userLibraryItem
  }

  /** @type {typeof import('./models/UserCollection')} */
  get userCollection() {
    return this.models.userCollection
  }

  /** @type {typeof import('./models/UserPlaylist')} */
  get userPlaylist() {
    return this.models.userPlaylist
  }
  ...
  buildModels(force = false) {
    ...
    require('./models/UserLibraryItem').init(this.sequelize)
    require('./models/UserCollection').init(this.sequelize)
    require('./models/UserPlaylist').init(this.sequelize)
