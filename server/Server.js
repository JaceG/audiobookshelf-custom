...
const PublicCustom = require('./routers/PublicCustom')
const AuthenticatedCustom = require('./routers/AuthenticatedCustom')
...
class Server {
  constructor(SOURCE, PORT, HOST, CONFIG_PATH, METADATA_PATH, ROUTER_BASE_PATH) {
    ...
    this.publicCustom = new PublicCustom(this)
    this.authenticatedCustom = new AuthenticatedCustom(this)
  ...
  async start() {
    ...
    router.use('/api/custom', this.auth.ifAuthNeeded(this.authMiddleware.bind(this)), this.authenticatedCustom.router)
    router.use('/api', this.auth.ifAuthNeeded(this.authMiddleware.bind(this)), this.apiRouter.router)
    router.use('/hls', this.authMiddleware.bind(this), this.hlsRouter.router)
    router.use('/public/custom', this.publicCustom.router)
